...
An agentic workflow that automates web research like searching, scraping, synthesizing, and critiquing reports on any topic. Built with **LangChain (LCEL)**, **Tavily Search API**, and **Streamlit**.
